...
const DATAFIELDS = [
    ...
    },
    {
        ...
        channels: [{
            ...
            channel: 'weather.maxvalues.absolut',
            name: 'Max. Rain (Daily) (absolut)'
        },{
            channel: 'weather.maxvalues.daily',
            name: 'Max. Rain (Daily) (daily)'
        }],
        type: 'number',
        unit: 'mm',
        role: 'value',
    ...
    },
    {
        ...
        channels: [{
            ...
            channel: 'weather.maxvalues.absolut',
            name: 'Max. Rain (Monthly) (absolut)'
        },{
            channel: 'weather.maxvalues.daily',
            name: 'Max. Rain (Monthly) (daily)'
        }],
        type: 'number',
        unit: 'mm',
        role: 'value',
    ...
    },
    {
        ...
        channels: [{
            channel: 'weather.current',
            name: 'Wind direction 10 min average'
        }],
        type: 'number',
        unit: '°',
        role: 'value.direction',
        min: 0,
        max: 359,
        wunderground: '^winddir_avg10m',
        ecowitt: '^winddir_avg10m',
        scheduler: null,
        listener_conversion: null,
        scheduler_conversion: null
    },    
    ...
    },
    {
        ...
        min: 0,
        max: 1000,
        wunderground: '^windspdmph_avg10m',
        ecowitt: '^windspdmph_avg10m',
        scheduler: null,
        listener_conversion: 'roundTo(x * 1.60934, 1)',
        scheduler_conversion: 'roundTo((x / 10 * 3.6),1)',
        unit_config: 'unit_windspeed',
